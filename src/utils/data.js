...
export const skills = [
  ...
  export const projects = [
...

    {
      ...
      website: 'http://helpful-client.herokuapp.com',
      stack: [
        {
          name: 'MongoDB',
          icon: 'https://img.icons8.com/color/48/000000/mongodb.png'
      ...
      description: "I worked with a remote development team to create a community service web app for my capstone project at Thinkful. We created the app with the MERN stack, using Agile Scrum methodologies to complete the MVP and market to Product Hunt in just three weeks. I wore many hats during the process including Scrum Master and Lead QA. I focused on some of the more difficult tasks involved such as Google Maps API integration and learning/teaching React Hooks to be used in place of Redux.",
      image: 'helpful'
    },
  
    {
      ...
      website: 'https://spaced-repetition-codey-ethan.herokuapp.com',
      stack: [
        {
          name: 'MongoDB',
          icon: 'https://img.icons8.com/color/48/000000/mongodb.png'
